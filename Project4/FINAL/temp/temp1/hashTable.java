...
private void readFile() throws Exception
{
	...
	java.io.File file = new java.io.File("newfile.txt");//Read the data from the file
...
private void doStuff()
{
         ...
         hashTable[key]= tokens[0];
         numTable[key] = Integer.parseInt(tokens[2]);
         opCode[key] = tokens[1];
...
public String getAddress(String label)
{
	for(int i = 0; i < symTable.size(); i++)
	{
	String[] tokens = symTable.get(i).split(" ");
